...
public:
    CMainParams() {
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1506659510, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1506659510;
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "80.209.237.202"));
        vSeeds.push_back(CDNSSeedData("seed2", "80.209.237.200"));
        vSeeds.push_back(CDNSSeedData("seed3", "80.209.237.198"));
        vSeeds.push_back(CDNSSeedData("seed4", "80.209.237.199"));
